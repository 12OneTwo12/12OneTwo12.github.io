---
title: "[MSA에 관한 고찰 3/6편] MSA에서의 서비스간 통신 - 어떻게 해야 하는가"
tags:
  - msa
  - architecture
  - distributed-systems
...
다음 편에서는 동기 호출에서 장애가 어떻게 전파되고, 이를 어디서 끊어야 하는지에 대해 이야기해보려고 합니다. 비동기의 데이터 일관성 문제는 5편 데이터 분리에서 다룰 예정입니다.

후편: [[MSA에 관한 고찰 4/6편] 장애는 어떻게 전파되고, 우리는 어디서 끊어야 하는가]({{< relref "/blog/architecture/msa-series-4-resilience" >}})
