---
title: "AI 부동산 매물 추천 시스템 구축기 - '강남역 근처 30평대 신축 아파트 추천해줘'를 처리하는 서비스를 만들기까지"
tags:
  - ai
  - llm
  - elasticsearch
...
최근 많은 회사들이 AI를 서비스에 어떻게 녹여내 유의미한 가치를 제공할 수 있을지 고민하고 계시는 것 같습니다.

저희 회사도 마찬가지입니다. 어떻게 하면 AI를 활용해서 사용자분들께 더 나은 경험을 제공할 수 있을까 고민을 꾸준히 해왔습니다.

그 과정에서 아무래도 부동산 도메인이다 보니 자연어로 부동산 매물을 추천하는 AI 기능을 만들게 되었습니다.
